...
?>
<!-- if there's any featured post it should be shown -->
        ...
        <section class="featured">
            <div class="container featured__container">
                <div class="post__thumbnail">
                    <?php
                        if ($featured && $featured['thumbnail']) {
                            ...
                            $image_info = getimagesizefromstring($featured['thumbnail']);
                            $mime_type = $image_info['mime'];

                            // Display the avatar using base64 encoding
                            $thumbnail_data = base64_encode($featured['thumbnail']);
                ...
                <div class="post__info">
                    ...
                    <p class="post__body">
                        <?= substr($featured['body'], 0, 300) // to get only 300 chars?>...
                    </p>
                    <div class="post__author">
                        ...
                        <div class="post__author-info">
                            ...
                            <small>
                                <?= date("M d, Y - H:i", strtotime($featured['date_time'])) // show the time when it was posted ?>
                            </small>
                        </div>
