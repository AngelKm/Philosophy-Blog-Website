...
FROM posts WHERE posts.author_id = $current_user_id
ORDER BY id DESC";
...
?>
        ...
        <?php endif ?>
            <div class="container dashboard__container">
                ...
                <main>
                    <h2>Manage Posts</h2>
                    <?php if(mysqli_num_rows($posts) > 0) : // if # of rows returned is > 0 ?>
                        <table>
                            <thead>
                                <tr>
                                    <th>Title</th>
                            ...
                            <tbody>
                                <?php while ($post = mysqli_fetch_assoc($posts)) : // loop through the table to display the users ?>
